    ...
    <div>
      ...
      >
        <div className="content">
          <text>You say you need proof do you? Well how about this:</text>
          <br></br>
          <text>
            <i>
              We reversed and pitched down the audio of the Ewoks talking.
        ...
        >
          ...
          <ReactAudioPlayer src={hailSatan} controls />
          <br></br>
          <br></br>
        </div>
        ...
        >
          <text>Translated</text> <br></br>
          <ReactAudioPlayer src={longDay} controls />
          <br></br>
          <br></br>
        </div>
        <div className="line"></div>
        ...
        >
          <text>Translated</text> <br></br>
          <ReactAudioPlayer src={youToo} controls />
          <br></br>
          <br></br>
        </div>
      </div>
