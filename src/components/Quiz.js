  ...
  const questions = [
    ...
    },
    {
      ...
      answerOptions: [
        ...
        {
          answerText: "They do not know how to talk yet so yes",
          isCorrect: false,
        },
        { answerText: "No", isCorrect: false },
      ],
      ...
      <div className="app">
        {showScore ? (
          <div className="score-section">
            Your childs Ewok Score is {score}. If their score is over 2, that
            means the ewoks have indoctrinated them! Get help immediately!
          </div>
        ) : (
          <>
